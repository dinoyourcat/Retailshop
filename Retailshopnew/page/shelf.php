...
include_once "../controller/shelf.php";
?>
  ...
  <div class="container-table">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <script>
          function Search() {
            ...
            window.location = 'shelf.php?ID=' + id;
          }
        </script>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">เพิ่มข้อมูลชั้นวางสินค้า</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                  <div class="mb-3">
                    <label for="" class="col-form-label">รหัสชั้นวางสินค้า :</label>
                    <input type="text" class="form-control" name="shelfno">
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">ชื่อชั้นวางสินค้า :</label>
    ...
    <table class="table  table-bordered border-dark table-hover">
      <thead class="table-secondary  table-bordered border-dark text-black">
        <tr>
          <th scope="col">รหัสชั้นวางสินค้า</th>
          <th scope="col">ชื่อชั้นวางสินค้า</th>
      ...
      <tbody>
        ...
        if (isset($_GET['ID'])) {
          $Search_id = $_GET['ID'];
          $sql = "SELECT * FROM shelf WHERE Shelf_no LIKE '%$Search_id%'";
        } else {
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#select_<?php echo $row['Shelf_no']; ?>" data-bs-whatever="@fat"><i class="bi bi-pencil-square" name="select_<?php echo $row['Shelf_no']; ?>"></i></button>
              <div class="modal fade" id="select_<?php echo $row['Shelf_no']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">แก้ไขข้อมูลชั้นวางสินค้า</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="modal-body">
                      <form method="POST">
                        ...
                        <div class="mb-3">
                          <label for="" class="col-form-label">รหัสชั้นวางสินค้า :</label>
                          <input type="text" class="form-control" name="shelfno" value="<?php echo $row['Shelf_no']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">ชื่อชั้นวางสินค้า :</label>
                          <input type="text" class="form-control" name="shelfname" value="<?php echo $row['Shelf_name']; ?>">
                        </div>
              ...
              <button type="button" class="btn btn-outline-danger" name="DEL_<?php echo $row['Shelf_no']; ?>" data-bs-toggle="modal" data-bs-target="#DEL_<?php echo $row['Shelf_no']; ?>">
                <i class="bi bi-trash3"></i>
              </button>

              <!-- Modal -->
              <form action="" method="post">
                <div class="modal fade" id="DEL_<?php echo $row['Shelf_no']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" name="delete" value="<?php echo $row['Shelf_no']; ?>">ยืนยัน</button>
                      </div>
                    </div>
                  </div>
                </div>
