...
include_once "../controller/procat.php";
?>
  ...
  <div class="container-table">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <script>
          function Search() {
            ...
            window.location = 'procat.php?ID=' + id;
          }
        </script>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                    <label for="" class="col-form-label">รหัสประเภทสินค้า :</label>
                    <input type="text" class="form-control" name="procatid">
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">ชื่อประเภทสินค้า :</label>
                    <input type="text" class="form-control" name="procatname">
                  </div>
    ...
    <table class="table  table-bordered border-dark table-hover">
      ...
      <tbody>
        ...
        if (isset($_GET['ID'])) {
          $Search_id = $_GET['ID'];
          $sql = "SELECT * FROM product_category WHERE Cate_id LIKE '%$Search_id%'";
        } else {
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#select_<?php echo $row['Cate_id']; ?>" data-bs-whatever="@fat"><i class="bi bi-pencil-square" name="select_<?php echo $row['Cate_id']; ?>"></i></button>
              <div class="modal fade" id="select_<?php echo $row['Cate_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <form method="POST">
                        <div class="mb-3">
                          <label for="" class="col-form-label">รหัสประเภทสินค้า :</label>
                          <input type="text" class="form-control" name="procatid" value="<?php echo $row['Cate_id']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">ชื่อประเภทสินค้า :</label>
                          <input type="text" class="form-control" name="procatname" value="<?php echo $row['Cate_name']; ?>">
                        </div>
              ...
              <button type="button" class="btn btn-outline-danger" name="DEL_<?php echo $row['Cate_id']; ?>" data-bs-toggle="modal" data-bs-target="#DEL_<?php echo $row['Cate_id']; ?>">
                <i class="bi bi-trash3"></i>
              </button>

              <!-- Modal -->
              <form action="" method="post">
                <div class="modal fade" id="DEL_<?php echo $row['Cate_id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" name="delete" value="<?php echo $row['Cate_id']; ?>">ยืนยัน</button>
                      </div>
                    </div>
                  </div>
                </div>
