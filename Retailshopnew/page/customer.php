  ...
  <div class="container-table">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <script>
          function Search() {
            ...
            window.location = 'customer.php?ID=' + id;
          }
        </script>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="cusid">
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">ชื่อ :</label>
                    <input type="text" class="form-control" id="" name="cusname">
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">นามสกุล :</label>
                    <input type="text" class="form-control" id="" name="cuslastname">
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">ที่อยู่ :</label>
                    <input type="text" class="form-control" id="" name="cusaddress">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="custel">
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="cusstatus">
                  </div>
    ...
    <table class="table  table-bordered border-dark table-hover">
      ...
      <tbody>
        ...
        if (isset($_GET['ID'])) {
          $Search_id = $_GET['ID'];
          $sql = "SELECT * FROM customer inner join province on customer.province_id=province.province_id WHERE cust_id LIKE '%$Search_id%'";
        } else {
          $sql = "SELECT * FROM customer inner join province on customer.province_id=province.province_id";
        }
        ...
        ?>
          ...
          <tr>
            ...
            <td>
              ...
              <button type="button" class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#select_<?php echo $row['Cust_id']; ?>" data-bs-whatever="@fat"><i class="bi bi-pencil-square" name="select_<?php echo $row['Cust_id']; ?>"></i></button>
              <div class="modal fade" id="select_<?php echo $row['Cust_id']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <form method="POST">
                        ...
                        <div class="mb-3">
                          <label for="" class="col-form-label">รหัสลูกค้า:</label>
                          <input type="text" class="form-control" name="cusid" value="<?php echo $row['Cust_id']; ?>">
                        </div>

                        <div class="mb-3">
                          <label for="" class="col-form-label">ชื่อ :</label>
                          <input type="text" class="form-control" name="cusname" value="<?php echo $row['Cust_name']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">นามสกุล :</label>
                          <input type="text" class="form-control" name="cuslastname" value="<?php echo $row['Cust_lastName']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">ที่อยู่ :</label>
                          <input type="text" class="form-control" name="cusaddress" value="<?php echo $row['Cust_address']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">ชื่อจังหวัด :</label>
                          <?php
                          $sql_previous = "SELECT * FROM customer inner join province on customer.province_id=province.province_id";
                        ...
                        <div class="mb-3">
                          <label for="" class="col-form-label">เบอร์โทร :</label>
                          <input type="text" class="form-control" name="custel" value="<?php echo $row['Cust_tel']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">วันที่ :</label>
                          <input type="date" class="form-control" name="date" value="<?php echo $row['Admit_date']; ?>">
                        </div>
                        <div class="mb-3">
                          <label for="" class="col-form-label">สถานะ :</label>
                          <input type="text" class="form-control" name="cusstatus" value="<?php echo $row['Cust_status']; ?>">
                        </div>
              ...
              <button type="button" class="btn btn-outline-danger" name="DEL_<?php echo $row['Cust_id']; ?>" data-bs-toggle="modal" data-bs-target="#DEL_<?php echo $row['Cust_id']; ?>">
                <i class="bi bi-trash3"></i>
              </button>

              <!-- Modal -->
              <form action="" method="post">
                <div class="modal fade" id="DEL_<?php echo $row['Cust_id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" name="delete" value="<?php echo $row['Cust_id']; ?>">ยืนยัน</button>
                      </div>
                    </div>
                  </div>
                </div>
